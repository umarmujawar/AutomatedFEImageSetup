...
echo "===========Ansible code written for FE by Yogesh and Tested by Gagan for "Provisionning by Ansible"====================="

ansible_bootstrap $IP

## create image
echo "===========After solving lots of S# issues finally we reached at this point "Lets Wait for image will be active now"================="
